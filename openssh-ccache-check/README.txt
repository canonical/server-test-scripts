Script to check if the openssh-server-default-ccache series of ppas[1][2][3] are
up to date regarding Ubuntu openssh SRUs and security updates.

This work is described in the US066 OpenSSH ccache spec[4].
